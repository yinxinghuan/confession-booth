...
- 游戏：Sin of the Week
- 类型：social
- 简述：Tell the AI hotline your sin at 1-800-CONFESS. Behind the grille isn't a priest but a gum-chewing call-center op with a damp script. ABSOLVED / DENIED / DEFERRED + a penance. Anonymous wall.
...
- 平台元信息：meta.title=Sin of the Week；cover_url=/poster.png；category=social；uuid=d50286e6-d7e7-4a0b-afbd-5af7d598a4b8
...
- `src/ConfessionBooth/ConfessionBooth.less`
- `src/ConfessionBooth/types.ts`
- `src/ConfessionBooth/index.ts`
- `src/ConfessionBooth/ConfessionBooth.tsx`
- `src/ConfessionBooth/utils/demo.ts`
- `src/ConfessionBooth/utils/audio.ts`
- `src/ConfessionBooth/utils/prompts.ts`
- `src/ConfessionBooth/utils/ticket.ts`
